...
esp_err_t ota_check_for_updates(const char* current_version, ota_version_info_t* update_info)
{
    ...
    strncpy(update_info->version, "3.5.2", sizeof(update_info->version) - 1);
    strncpy(update_info->url, "https://updates.askme.it/firminia/v3.5.2/firmware.bin", 
            sizeof(update_info->url) - 1);
    strncpy(update_info->signature_url, "https://updates.askme.it/firminia/v3.5.2/firmware.sig", 
